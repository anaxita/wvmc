...
func (s *ServerService) GetServerData(server model.Server, hv string, name string) (model.Server,
	error) {
...
func (s *ServerService) DisconnectRDPUser(ip, user, password string, sessionID int) ([]byte,
	error) {
